 ...
 *   :meth:`bytealign` -- Align to next byte boundary.
 *   :meth:`peek` -- Peek at and interpret next bits as a single item.
 *   :meth:`peeklist` -- Peek at and interpret next bits as a list of items.
 *   :meth:`read` -- Read and interpret next bits as a single item.
 *   :meth:`readlist` -- Read and interpret next bits as a list of items.
