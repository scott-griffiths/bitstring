...
import bitstring
from bitstring import BitArray, Bits, ConstByteStore, MmapByteArray
...
class Mmap(unittest.TestCase):
    ...
    def testByteArrayEquivalence(self):
        ...
        self.assertEqual(
            a[:], bytearray([0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF])
        )
...
class Iteration(unittest.TestCase):
    ...
    def testIterateLongBits(self):
        self.assertEqual(list(Bits([1, 0]) * 1024), [True, False] * 1024)
