...
if __name__ == '__main__':
    ...
    with open('./bitstring/luts.py', 'w') as f:
        ...
        for (exp_bits, mantissa_bits, bias, mxfp_overflow) in mxfp_formats:
            lut_int_to_float = createLUT_for_int_to_float(exp_bits, mantissa_bits, bias)
            lut_float16_to_mxfp = createLUT_for_float16_to_mxfp(lut_int_to_float, exp_bits, mantissa_bits, mxfp_overflow)
            ...
            mxfp_luts_compressed[(exp_bits, mantissa_bits, bias, mxfp_overflow)] = (lut_int_to_float_compressed, lut_float16_to_mxfp_compressed)
